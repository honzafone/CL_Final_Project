...
import NeptuneModel from '../models/Neptune';  // Importuj komponentu
import PlanetDescription from '../components/PlanetDescription';

function ViewNeptune() {
    ...
    useEffect(() => {
        ...
        const fetchPlanetData = async () => {
          try {
            const response = await fetch('https://api.le-systeme-solaire.net/rest/bodies/neptune');
