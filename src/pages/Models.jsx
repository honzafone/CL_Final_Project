...
import starBackground from '../assets/starsky.jpg'; // Wallpaper
...
const Models = () => {
    ...
    // PLANETS
    const planets = ["mercury", "venus", "earth", "mars", "jupiter", "saturn", "uranus", "neptune", "sun", "blackhole"];

    //STYLES FOR SIDEBAR
    const linkStyles = (isActive) =>
        `py-2 px-4 rounded font-bold ${isActive
    ...
    return (
        <body className="flex " style={{ position: 'relative', overflow: '' }}>
            {/* Parallax background */}
            <div
                style={{
                    position: 'fixed',
            ...
            {/* SIDEBAR */}
            <div
                className="hidden top-0 left-0 h-screen w-[10rem] bg-black shadow md:fixed md:block md:animate-slideInFromLeft border-r border-collapse border-customMuted"
            ...
            {/* BURGER MENU BUTTON */}
            <div className="p-4 md:hidden text-2xl mt-10 z-[1000]">
                <button
                    onClick={toggleMenu}
            ...
            <div className="fixed ml-0 p-0 w-full md:static md:ml-[10rem]">
