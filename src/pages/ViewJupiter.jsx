...
import JupiterModel from '../models/Jupiter';  // Importuj komponentu
import PlanetDescription from '../components/PlanetDescription';

function ViewJupiter() {
    ...
    useEffect(() => {
        ...
        const fetchPlanetData = async () => {
          try {
            const response = await fetch('https://api.le-systeme-solaire.net/rest/bodies/jupiter');
